...
model = joblib.load("compatible_risk_level_model.pkl")
vectorizer = joblib.load("compatible_hazard_vectorizer.pkl")
label_encoder = joblib.load("compatible_label_encoder.pkl")
